function ex46G (){
    ...
    while (valor < 15) {
     ...
     fibonacci = primeiroN + anterior
     alert (+contadora+" : "+fibonacci)
     anterior = primeiroN
     primeiroN = fibonacci
     valor++
